...
width:90%;
  ...
  <div class="container-fluid">
    ...
    <div class="text1">
      <h1>Candidates</h1>
      <a href="index.html" class="text2" role="text">Home</a><a type="text"> > Candidates</a>
    </div>
    </div>

  <!--- candidate list -->
  
  <h1 class="conatiner text-center">Find Your Desired Candidates</h1>                                                              
  <section id ="en">
  ...
  <tbody>
    <tr>
      ...
      <td><a href="file:///C:/Users/GALIB-PC/Desktop/e%20py/apply.html"> Contact </a></td>
  </tr>
  <tr>
      <th scope="row">2</th>
      <td>Kamrul Islam</td>
